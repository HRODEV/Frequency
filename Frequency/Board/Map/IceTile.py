...
class IceTile(Tile):
    ...
    def __init__(self, position: Vector2, size: Vector2=None, units=None, texture=None, rectangle=None):
        texture = texture if texture is not None else pygame.transform.scale(pygame.image.load('images/tiles/Ice.jpg'), [size.X, size.Y])
    ...
    def Update(self, game):
        ...
        return IceTile(nself.Position, nself.Size, nself.Units, nself.Texture, nself.Rectangle)
