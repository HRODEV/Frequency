...
class SettingsMenu(HeadMenu):
    ...
    def __init__(self, resolution, background=None, logo=None, dropDown=None, saveButton=None, fullscreen=None, soundButton=None):
        ...
        self.ResolutionDropDown = dropDown if dropDown is not None else DropDown(resolutions, Vector2(resolution.X // 2, 300), resolution)
    ...
    def Update(self, game):
        ...
        if self.SaveButton.IsClickedByMouse(game):
            ...
            return SettingsMenu(game.Settings.Resolution, self.Background, self.Logo, newDropDown, saveButton, fullscreenButton, toggleSoundButton)
